...
module.exports = async function (activity) {
  try {
    ...
    const response = await api(`/alert/my?page=${pagination.page}&pageSize=${pagination.pageSize}` +
    ...
    if (parseInt(pagination.page) == 1) {
      ...
      if (value > 0) {
        ...
        activity.Response.Data.description = value > 1 ? T(activity, "You have {0} alerts.", value)
          : T(activity, "You have 1 alert.");
      } else {
