...
module.exports = async function (activity) {
  try {
    ...
    const response = await api(`/ticket/open?page=${pagination.page}&pageSize=${pagination.pageSize}` +
    ...
    if (value > 0) {
      ...
      activity.Response.Data.description = value > 1 ? T(activity, "There are {0} open tickets.", value)
        : T(activity, "There is 1 open ticket.");
    } else {
