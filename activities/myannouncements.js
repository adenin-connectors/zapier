...
module.exports = async function (activity) {
  try {
    ...
    const response = await api(`/announcement/my?page=${pagination.page}&pageSize=${pagination.pageSize}` +
    ...
    if (parseInt(pagination.page) == 1) {
      ...
      if (value > 0) {
        ...
        activity.Response.Data.description = value > 1 ? T(activity, "You have {0} announcements.", value)
          : T(activity, "You have 1 announcement.");
      } else {
