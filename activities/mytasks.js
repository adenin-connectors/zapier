  ...
  try {
    ...
    if (parseInt(pagination.page) == 1) {
      ...
      if (value > 0) {
        ...
        activity.Response.Data.description = value > 1 ? T(activity, "You have {0} assigned tasks.", value)
          : T(activity, "You have 1 assigned task.");
      } else {
        activity.Response.Data.description = T(activity, `You have no tasks assigned.`);
      }
    }
  } catch (error) {
