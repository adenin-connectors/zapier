...
module.exports = async function (activity) {
  try {
    ...
    const response = await api(`/issue/open?page=${pagination.page}&pageSize=${pagination.pageSize}` +
    ...
    if (value > 0) {
      ...
      activity.Response.Data.description = value > 1 ? T(activity, "There are {0} open issues.", value)
        : T(activity, "There is 1 open issue.");
    } else {
